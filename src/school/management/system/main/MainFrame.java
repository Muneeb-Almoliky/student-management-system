...
public class MainFrame extends JFrame {
    ...
    public MainFrame() throws IOException {
        ...
        ImageIcon studentsIcon = new ImageIcon(getClass().getClassLoader().getResource("resources/images/students-icon.jpg"));
        Image scaledIStudensImage = studentsIcon.getImage().getScaledInstance(80, 80, Image.SCALE_SMOOTH);

        ImageIcon teachersIcon = new ImageIcon(getClass().getClassLoader().getResource("resources/images/teachersicon.jpg"));
        Image scaledTeachersImage = teachersIcon.getImage().getScaledInstance(80, 80, Image.SCALE_SMOOTH);

        ImageIcon coursesIcon = new ImageIcon(getClass().getClassLoader().getResource("resources/images/coursesicon.png"));
        Image scaledCoursesImage = coursesIcon.getImage().getScaledInstance(80, 80, Image.SCALE_SMOOTH);

        ImageIcon gradesIcon = new ImageIcon(getClass().getClassLoader().getResource("resources/images/gradesicon.png"));
        Image scaledGradesImage = gradesIcon.getImage().getScaledInstance(80, 80, Image.SCALE_SMOOTH);


        JPanel buttonsPanel = new JPanel();
        JButton studentFrameButton = new RoundedButton(new ImageIcon(scaledIStudensImage), 10);
        JButton courseFrameButton = new RoundedButton(new ImageIcon(scaledCoursesImage), 10);
        JButton teacherFrameButton = new RoundedButton(new ImageIcon(scaledTeachersImage), 10);
